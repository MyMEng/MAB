...
Lets assume we are given uniform prior over all available actions and each arm is normally distributed with mean $\mu_a$ and variance $\sigma^2_a$. As ties are broken randomly we choose any action in first round.
