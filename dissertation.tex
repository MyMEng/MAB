...
\footnote*{This dissertation together with all figures and experiment source code is available as \texttt{GitHub} repository at: \url{Reinforcement-Learning}.}
...
This chapter is entirely devoted to conducted experiment.\\
...
\begin{figure}[htbp]
  ...
  \begin{tiny}
    \caption{Change of mean(risk of hypothesis) estimation along experiment time. Colours correspond to hypothesis shown in figure~\ref{fig:hyp}.\label{fig:conv}}
  \end{tiny}
  \vspace{1cm}
\end{figure}
...
\newpage
\begin{center} \textbf{\huge ~\vspace*{15cm} FIN} \end{center}
