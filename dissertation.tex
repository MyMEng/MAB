...
Thompson Sampling was first proposed in 1933 by William R.\ Thompson~\citep{thompson:biom33} and mainly concerned Bernoulli processes. In this section we explain this approach and discuss related work extending originally proposed methodology~\citep{May:2012:OBS:2503308.2343711}.\\
Described solution is widely used for on-line advertising by IT giants like Microsoft due to its simplicity, flexibility and scalability~\cite{graepel2010web}.
...
To utilize introduced above approach we need to get \emph{posterior} for each action to draw a sample.
