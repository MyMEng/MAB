...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.7\textwidth]{graphics/cluster.png}
\begin{tiny}
\caption{Sampling and updating posterior probability density function of normal distribution $\mathcal{N}\left( \mu , \sigma^2 \right)$ (Figure taken from~\cite{Jacobs2008normalnormal}).\label{fig:cluster}}
\end{tiny}
\vspace{1cm}
\end{figure}
