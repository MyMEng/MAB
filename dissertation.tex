...
There are many algorithms which build models based on small sample of labeled data provided but only a few of them measure and utilize information about ... maximally informative points.\\
...
No upfront labeled daa set\\
advantage: we can choose which points to query\\
