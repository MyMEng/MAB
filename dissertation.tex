...
The main application area of semi-supervised learning is natural language, video or audio processing and other fields where data are relatively easy to acquire --- for instance by placing a camera .

Naturla language proessing
