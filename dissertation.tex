...
Calculating $\hat{c}$ for each $x_i$ during arbitrary round $t$ allows us to utilize this information to calculate corresponding loss. Calculating $z(x_i)$ in given above way also 
